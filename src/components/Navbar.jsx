              ...
              {session ? (
                <div className="flex items-center gap-4">
                  ...
                  <button 
                    ...
                    className="text-[10px] font-black uppercase tracking-widest px-4 py-2 bg-slate-100 rounded-lg hover:bg-red-50 hover:text-red-600 transition"
                  >
                    Logout
                  </button>
                </div>
                ...
                <div className="flex items-center gap-2">
                  <Link href="/login" className="text-[10px] font-black uppercase tracking-widest px-4 py-2 hover:text-yellow-500 transition">Login</Link>
                  <Link href="/register" className="text-[10px] font-black uppercase tracking-widest px-4 py-2 bg-slate-900 text-white rounded-lg hover:bg-slate-800 transition shadow-md">Register</Link>
                </div>
              )}
            </>
          )}
